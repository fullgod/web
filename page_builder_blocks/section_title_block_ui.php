...
class AQ_Section_Title_Block_Ui extends AQ_Block {
	...
	function __construct() {
		$block_options = array(
			...
			'block_description' => 'Изпользуется для заголока блока',
			'block_category' => 'text'
		);
		
		//create the block
		parent::__construct('aq_section_title_block_ui', $block_options);
	}//end construct
