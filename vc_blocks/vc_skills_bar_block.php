...
function ebor_skills_bar_shortcode( $atts ) {
	...
	$output = '<div class="'. $alignment .' skills skill-bars"><ul class="skills-ul"><li><span>'. htmlspecialchars_decode($title) .'</span><div class="skill-bar-holder"><div class="skill-capacity" style="width: '. (int)$number .'%;"></div></div></li></ul></div>';
